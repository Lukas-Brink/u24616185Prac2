...
namespace u24616185Prac2.Controllers
{
    public class PeopleController : Controller
    {
        public ActionResult Index()
        {
            ...
            people.Add(new Models.PersonModel { StudentNumber = "u24647502", FirstName = "Kelly", LastName = "Johnson", EmailAddress = "u24647502@tuks.co.za", MyLink = "~/HTML/KellyJohnson" });
